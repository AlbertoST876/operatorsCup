    ...
    <nav class="flex max-w-screen-xl mx-auto flex-wrap items-center justify-between">
        ...
        <div class="hidden lg:flex w-full lg:w-auto lg:items-center lg:justify-between lg:order-1" id="navbar-default">
            <ul class="flex p-4 lg:p-0 flex-col space-y-2 lg:flex-row lg:space-x-4 lg:space-y-0 mt-4 lg:mt-0  font-bold">
                ...
                <li class="transition-all duration-300 hover:bg-white rounded-lg"><a href="{{ route("teams") }}" class="block px-4 py-2 text-lg text-white hover:text-black md:hover:bg-transparent rounded-0 md:rounded-lg">@lang("app.teams")</a></li>
                <li class="transition-all duration-300 hover:bg-white rounded-lg"><a href="{{ route("calendar") }}" class="block px-4 py-2 text-lg text-white hover:text-black md:hover:bg-transparent rounded-0 md:rounded-lg">@lang("app.calendar")</a></li>
                <li class="transition-all duration-300 hover:bg-white rounded-lg"><a href="{{ route("ranking") }}" class="block px-4 py-2 text-lg text-white hover:text-black md:hover:bg-transparent rounded-0 md:rounded-lg">@lang("app.ranking")</a></li>
