        ...
        <main class="block w-full p-4">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid my-8 gap-4 sm:gap-8 grid-cols-1 sm:grid-cols-2">
                    ...
                    @if (!(is_null($team -> discord) && is_null($team -> x) && is_null($team -> twitch) && is_null($team -> youtube)))
                        <div>
                            ...
                            <div class="flex flex-wrap md:flex-nowrap items-center justify-center">
                                ...
                                @if (!is_null($team -> x)) <a class="mx-2 my-4 w-12 h-12" target="_blank" href="{{ $team -> x }}"><img class="rounded-md" src="{{ asset("storage/images/social-networks/x.png") }}" alt="X"></a> @endif
                        ...
                        @foreach ($team -> members as $member)
                            <div class="flex px-4 py-2 flex-nowrap items-center justify-between bg-gray-100 rounded-lg">
                                ...
                                <div class="flex flex-nowrap items-center justify-center">
                                    @if (!is_null($member -> x)) <a class="mx-1 my-2 w-8 h-8" target="_blank" href="{{ $member -> x }}"><img class="rounded-md" src="{{ asset("storage/images/social-networks/x.png") }}" alt="X"></a> @endif
